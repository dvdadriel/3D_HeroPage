    ...
    return (
        <header className='flex justify-between items-center py-4 px-4 lg:px-20'>
            ...
            <nav className='hidden md:flex items-center gap-12'>
                ...
                <a data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000" className="text-base tracking-wider transition-colors hover:text-gray-300 z-50" href="#">RESOURCES</a>
            ...
            <button className='hidden md:block bg-[#a7a7a7] text-black py-3 px-8 rounded-full border-none font-medium transition-all duration-500 hover:bg-white cursor=pointer z-50'>SIGNIN</button>
